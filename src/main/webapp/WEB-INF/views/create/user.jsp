...
<!-- Modal Form -->
<div id="modalFormUser" class="modal-block modal-block-primary mfp-hide">
    <div class="panel panel-primary">
        <!--<form id="form" action="form-validation.html" class="form-horizontal">-->
        <form id="userForm" action="${pageContext.servletContext.contextPath}/user/add" method="post" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">                 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="password" id="fpass" name="password" class="form-control" placeholder="密码" required/>
                        </div>
                    </div>     
<!--                    <div class="form-group">
                        <label class="col-md-2 control-label" for="text-input">确认密码 <span class="required">*</span></label>
                        <div class="col-md-9">
                            <input type="password" id="rpass" name="passwordRepeat" class="form-control" placeholder="确认密码" required/>
                        </div>
                    </div>   -->
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <select id="userTypeSelect" name="userType" class="form-control" size="1" required>
                                <option value="">请选择</option>
                                <option value="0">总务财务</option>
                                <option value="1">总部客服</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <select id="userRankSelect" name="userRank" class="form-control" required>
                                <option value="">请选择</option>
                            ...
                            <label class="error" for="userRankSelect"></label>
                        </div>
                    </div> 
                    <div class="form-group">
