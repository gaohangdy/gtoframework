                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="avatar">
                            <a href="page-inbox.html">
                                <img class="avatar" src="resources/assets/img/avatar1.jpg" alt="" />
                        ...
                        <li class="avatar">
                            <a href="page-inbox.html">
                                <img class="avatar" src="resources/assets/img/avatar2.jpg" alt="" />
                                <div><div class="point point-primary point-lg"></div>New message</div>
                        ...
                        <li class="avatar">
                            <a href="page-inbox.html">
                                <img class="avatar" src="resources/assets/img/avatar3.jpg" alt="" />
                                <div><div class="point point-primary point-lg"></div>New message</div>
                        ...
                        <li class="avatar">
                            <a href="page-inbox.html">
                                <img class="avatar" src="resources/assets/img/avatar4.jpg" alt="" />
                                <div><div class="point point-primary point-lg"></div>New message</div>
                        ...
                        <li class="avatar">
                            <a href="page-inbox.html">
                                <img class="avatar" src="resources/assets/img/avatar5.jpg" alt="" />
                                <div><div class="point point-primary point-lg"></div>New message</div>
            ...
            <div class="userbox">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <figure class="profile-picture hidden-xs">
                        <img src="resources/assets/img/avatar.jpg" class="img-circle" alt="" />
                    </figure>
